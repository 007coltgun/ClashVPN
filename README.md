...
> تمام سایت هایی که سرور انها در داخل ایران است و یا از دامنه .ir استفاده میکنند به صورت خودکار از اینترنت اصلی شما با ای پی ایران استفاده میکنند. برای تست میتوانید بعد از اتصال از طریق این سایت [Iran IP](https://www.speedcheck.ir/) و این سایت [VPN IP](http://www.myip.ms/) ای پی ایران و خارج خود را همزمان چک کنید.
