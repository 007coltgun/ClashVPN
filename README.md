...
> تمام سایت هایی که سرور انها در داخل ایران است و یا از دامنه .ir استفاده میکنند به صورت خودکار از اینترنت اصلی شما با ای پی ایران استفاده میکنند. برای تست میتوانید بعد از اتصال از طریق این سایت [Iran IP](http://www.speedcheck.ir/) و این سایت [VPN IP](http://www.myip.ms/) ای پی ایران و خارج خود را همزمان چک کنید.
...
> پیشنهاد سرآشپز  کانکشن ترکیبی آلمان و هلند و فرانسه و انگلستان [لینک کانکشن](https://raw.githubusercontent.com/MEHR1DAD/ClashVPN/main/conn/GermanyNetherlandsFranceUk.yaml) است.
<div  dir="rtl">
...
<img
  ...
  title="Donate"
  style="display: inline-block; margin: 0 auto; max-width: 100 px">
