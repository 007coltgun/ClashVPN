...
> تمام سایت هایی که سرور انها در داخل ایران است و یا از دامنه .ir استفاده میکنند به صورت خودکار از اینترنت اصلی شما با ای پی ایران استفاده میکنند. برای تست میتوانید بعد از اتصال از طریق این سایت [Iran IP](http://www.speedcheck.ir/) و این سایت [VPN IP](https://ipleak.net/) ای پی ایران و خارج خود را همزمان چک کنید.
...
- این کانکشن ها کاملا رایگان است و فروش یا کسب درامد از آن با اصل آزادی و شرافت انسانی در تضاد است.
<div  dir="rtl">
...
<div  dir="rtl">
- کانکشن ترکیبی آلمان، هلند، فرانسه و انگلستان [لینک کانکشن](https://raw.githubusercontent.com/MEHR1DAD/ClashVPN/main/conn/GermanyNetherlandsFranceUk-light.yaml)  بهترین کانکشن است.
<div  dir="rtl">
...
> پیشنهاد سرآشپز  کانکشن ترکیبی آلمان و هلند و فرانسه و انگلستان [لینک کانکشن](https://raw.githubusercontent.com/MEHR1DAD/ClashVPN/main/conn/GermanyNetherlandsFranceUk-light.yaml) است.
<div  dir="rtl">
...
> بهترین روش اتصال استفاده از کانکشن های چند سرور است که کیفیت اتصال را تضمین میکند - در این روش ای پی شما بین چند لوکیشن متعییر است و ممکن است برای استفاده های خاص مانند ترید مناسب نباشد. پیشنهاد سرآشپز  کانکشن ترکیبی آلمان و هلند و فرانسه و انگلستان [لینک کانکشن](https://raw.githubusercontent.com/MEHR1DAD/ClashVPN/main/conn/GermanyNetherlandsFranceUk-light.yaml) است. 
